...
public class UserController {
    ...
    /**
     * This method is for getting all the user details from database
    ...
    /**
     * By email parameters we are able to retrieve data through email
     * @param email
     * @return User Info
     */
    ...
    /**
     * this method is for validating user information,
     * if all the user fields are present, it will return true,
     * if some of the user fields are missing, it will return false
     * @param user user object
     * @return true or false based on user information
     */
